...
class Filters extends Adminltetags
{
    ...
    protected function generateContent()
    {
        ...
        // $employeesPackage = $this->init()->checkPackage('Apps\Fintech\Packages\Hrms\Employees\Employees');

        // if ($employeesPackage) {
        //     $employeesPackage = new \Apps\Fintech\Packages\Hrms\Employees\Employees;
        // }
